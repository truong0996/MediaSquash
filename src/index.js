...
program
    ...
    .option('-q, --quality <number>', 'Quality level (1-100, default: 75)', '75')
...
program
    ...
    .option('-o, --output <path>', 'Output file path or directory')
    .option('-c, --crf <number>', 'CRF value (0-51, lower = better quality, default: 23)', '23')
...
program
    ...
    .option('-q, --quality <number>', 'Image quality (1-100, default: 75)', '75')
    .option('-c, --crf <number>', 'Video CRF (0-51, default: 23)', '23')
    .option('-e, --encoder <encoder>', 'Video encoder: auto, nvenc, qsv, cpu (default: auto)', 'auto')
